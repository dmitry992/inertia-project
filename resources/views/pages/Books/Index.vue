<template>
    ...
    <div class="s-book-list">
        ...
        />
        <div class="s-book-list-test">
            Вывод Props :
            <p>Число: {{ number }}</p>
            <p>Строка : {{ title }}</p>
            <p>Массив:</p>
            <ul>
                <li v-for="el in test_array" :key="el">
                    {{ el }}
                </li>
            </ul>
            ...
            <p>Объект :</p>
            <div>
                Пользователь : {{test_object.user}}
                Почта : {{test_object.email}}
            </div>
        </div>
    </div>
...
const books = ref([
    ...
    },
    {
        ...
        cover: "https://basket-20.wbbasket.ru/vol3418/part341876/341876781/images/big/1.webp",
        adult: false,
        rating: null
    },
    {
